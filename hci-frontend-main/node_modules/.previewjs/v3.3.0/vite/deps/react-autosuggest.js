...
var require_compareObjects = __commonJS({
  "node_modules/react-autowhatever/dist/compareObjects.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_SectionTitle = __commonJS({
  "node_modules/react-autowhatever/dist/SectionTitle.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _compareObjects = require_compareObjects();
    ...
    var SectionTitle = function(_Component) {
      ...
      function SectionTitle2() {
        ...
        return _possibleConstructorReturn(this, (SectionTitle2.__proto__ || Object.getPrototypeOf(SectionTitle2)).apply(this, arguments));
      }
      _createClass(SectionTitle2, [{
        ...
        value: function render() {
          var _props = this.props, section = _props.section, renderSectionTitle = _props.renderSectionTitle, theme = _props.theme, sectionKeyPrefix = _props.sectionKeyPrefix;
...
var require_Item = __commonJS({
  "node_modules/react-autowhatever/dist/Item.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var Item = function(_Component) {
      ...
      _createClass(Item2, [{
        ...
        key: "render",
        value: function render() {
          var _props = this.props, isHighlighted = _props.isHighlighted, item = _props.item, renderItem = _props.renderItem, renderItemData = _props.renderItemData, restProps = _objectWithoutProperties(_props, ["isHighlighted", "item", "renderItem", "renderItemData"]);
          ...
          return _react2.default.createElement("li", _extends({ role: "option" }, restProps, { ref: this.storeItemReference }), renderItem(item, _extends({ isHighlighted }, renderItemData)));
        }
      }]);
      return Item2;
    }(_react.Component);
...
var require_ItemsList = __commonJS({
  "node_modules/react-autowhatever/dist/ItemsList.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var ItemsList = function(_Component) {
      ...
      function ItemsList2() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ItemsList2.__proto__ || Object.getPrototypeOf(ItemsList2)).call.apply(_ref, [this].concat(args))), _this), _this.storeHighlightedItemReference = function(highlightedItem) {
      ...
      _createClass(ItemsList2, [{
        ...
        value: function render() {
          ...
          return _react2.default.createElement("ul", _extends({ role: "listbox" }, theme(sectionPrefix + "items-list", "itemsList")), items.map(function(item, itemIndex) {
            ...
            var itemPropsObj = isItemPropsFunction ? itemProps({ sectionIndex, itemIndex }) : itemProps;
...
var require_Autowhatever = __commonJS({
  "node_modules/react-autowhatever/dist/Autowhatever.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _propTypes = require_prop_types();
    var _propTypes2 = _interopRequireDefault(_propTypes);
    var _sectionIterator = require_dist();
    var _sectionIterator2 = _interopRequireDefault(_sectionIterator);
    var _reactThemeable = require_dist2();
    var _reactThemeable2 = _interopRequireDefault(_reactThemeable);
    var _SectionTitle = require_SectionTitle();
    var _SectionTitle2 = _interopRequireDefault(_SectionTitle);
    var _ItemsList = require_ItemsList();
    ...
    var Autowhatever = function(_Component) {
      ...
      function Autowhatever2(props) {
        ...
        var _this = _possibleConstructorReturn(this, (Autowhatever2.__proto__ || Object.getPrototypeOf(Autowhatever2)).call(this, props));
      ...
      _createClass(Autowhatever2, [{
        ...
        value: function renderSections() {
          ...
          var _props = this.props, id = _props.id, items = _props.items, renderItem = _props.renderItem, renderItemData = _props.renderItemData, renderSectionTitle = _props.renderSectionTitle, highlightedSectionIndex = _props.highlightedSectionIndex, highlightedItemIndex = _props.highlightedItemIndex, itemProps = _props.itemProps;
        ...
        value: function renderItems() {
          ...
          var theme = this.theme;
          var _props2 = this.props, id = _props2.id, renderItem = _props2.renderItem, renderItemData = _props2.renderItemData, highlightedSectionIndex = _props2.highlightedSectionIndex, highlightedItemIndex = _props2.highlightedItemIndex, itemProps = _props2.itemProps;
        ...
        value: function render() {
          var theme = this.theme;
          var _props3 = this.props, id = _props3.id, multiSection = _props3.multiSection, renderInputComponent = _props3.renderInputComponent, renderItemsContainer = _props3.renderItemsContainer, highlightedSectionIndex = _props3.highlightedSectionIndex, highlightedItemIndex = _props3.highlightedItemIndex;
...
var require_dist3 = __commonJS({
  "node_modules/react-autowhatever/dist/index.js"(exports, module) {
    "use strict";
    module.exports = require_Autowhatever().default;
  }
});
...
var require_theme = __commonJS({
  "node_modules/react-autosuggest/dist/theme.js"(exports) {
    ...
    var mapToAutowhateverTheme = exports.mapToAutowhateverTheme = function mapToAutowhateverTheme2(theme) {
      var result = {};
...
var require_Autosuggest = __commonJS({
  "node_modules/react-autosuggest/dist/Autosuggest.js"(exports) {
    ...
    var _reactAutowhatever = require_dist3();
    ...
    var Autosuggest = function(_Component) {
      ...
      function Autosuggest2(_ref2) {
        ...
        var _this = _possibleConstructorReturn(this, (Autosuggest2.__proto__ || Object.getPrototypeOf(Autosuggest2)).call(this));
      ...
      _createClass(Autosuggest2, [{
        ...
        value: function componentDidUpdate(prevProps, prevState) {
          var _props = this.props, suggestions = _props.suggestions, onSuggestionHighlighted = _props.onSuggestionHighlighted, highlightFirstSuggestion = _props.highlightFirstSuggestion;
        ...
        value: function getSuggestion(sectionIndex, suggestionIndex) {
          var _props2 = this.props, suggestions = _props2.suggestions, multiSection = _props2.multiSection, getSectionSuggestions = _props2.getSectionSuggestions;
          if (multiSection) {
        ...
        value: function getHighlightedSuggestion() {
          var _state = this.state, highlightedSectionIndex = _state.highlightedSectionIndex, highlightedSuggestionIndex = _state.highlightedSuggestionIndex;
        ...
        value: function maybeCallOnChange(event, newValue, method) {
          var _props$inputProps = this.props.inputProps, value = _props$inputProps.value, onChange = _props$inputProps.onChange;
          if (newValue !== value) {
        ...
        value: function render() {
          var _this3 = this;
          var _props3 = this.props, suggestions = _props3.suggestions, renderInputComponent = _props3.renderInputComponent, onSuggestionsFetchRequested = _props3.onSuggestionsFetchRequested, renderSuggestion = _props3.renderSuggestion, inputProps = _props3.inputProps, multiSection = _props3.multiSection, renderSectionTitle = _props3.renderSectionTitle, id = _props3.id, getSectionSuggestions = _props3.getSectionSuggestions, theme = _props3.theme, getSuggestionValue = _props3.getSuggestionValue, alwaysRenderSuggestions = _props3.alwaysRenderSuggestions, highlightFirstSuggestion = _props3.highlightFirstSuggestion;
          var _state2 = this.state, isFocused = _state2.isFocused, isCollapsed = _state2.isCollapsed, highlightedSectionIndex = _state2.highlightedSectionIndex, highlightedSuggestionIndex = _state2.highlightedSuggestionIndex, valueBeforeUpDown = _state2.valueBeforeUpDown;
          ...
          var autowhateverInputProps = _extends({}, inputProps, {
            ...
            onChange: function onChange(event) {
              ...
              var shouldRender = shouldRenderSuggestions(value2);
              ...
              if (shouldRender) {
                onSuggestionsFetchRequested({ value: value2, reason: "input-changed" });
              } else {
                _this3.onSuggestionsClearRequested();
              }
            },
    ...
    Autosuggest.propTypes = {
      ...
      inputProps: function inputProps(props, propName) {
        ...
        if (!inputProps2.hasOwnProperty("value")) {
          throw new Error("'inputProps' must have 'value'.");
        }
        if (!inputProps2.hasOwnProperty("onChange")) {
    ...
    var _initialiseProps = function _initialiseProps2() {
      ...
      this.onSuggestionSelected = function(event, data) {
        var _props4 = _this4.props, alwaysRenderSuggestions = _props4.alwaysRenderSuggestions, onSuggestionSelected = _props4.onSuggestionSelected, onSuggestionsFetchRequested = _props4.onSuggestionsFetchRequested;
      ...
      this.onSuggestionClick = function(event) {
        var _props5 = _this4.props, alwaysRenderSuggestions = _props5.alwaysRenderSuggestions, focusInputOnSuggestionClick = _props5.focusInputOnSuggestionClick;
        var _getSuggestionIndices = _this4.getSuggestionIndices(_this4.findSuggestionElement(event.target)), sectionIndex = _getSuggestionIndices.sectionIndex, suggestionIndex = _getSuggestionIndices.suggestionIndex;
      ...
      this.onBlur = function() {
        var _props6 = _this4.props, inputProps = _props6.inputProps, shouldRenderSuggestions = _props6.shouldRenderSuggestions;
        ...
        onBlur && onBlur(_this4.blurEvent, { highlightedSuggestion });
      };
      this.onSuggestionMouseLeave = function(event) {
        _this4.resetHighlightedSuggestion(false);
...
// dep:react-autosuggest
var react_autosuggest_default = require_dist4();
export {
  react_autosuggest_default as default
};
